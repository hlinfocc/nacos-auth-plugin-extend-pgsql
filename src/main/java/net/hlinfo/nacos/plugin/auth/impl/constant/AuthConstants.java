...
package net.hlinfo.nacos.plugin.auth.impl.constant;
...
public class AuthConstants {
    ...
    public static final String AUTH_PLUGIN_TYPE = "nacos_pg";
    ...
    public static final Long DEFAULT_TOKEN_EXPIRE_SECONDS = 18000L;
