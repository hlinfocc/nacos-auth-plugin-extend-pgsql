...
package net.hlinfo.nacos.plugin.auth.impl;

import com.alibaba.nacos.auth.config.AuthConfigs;
import com.alibaba.nacos.common.utils.StringUtils;
import com.alibaba.nacos.core.code.ControllerMethodsCache;
import net.hlinfo.nacos.plugin.auth.impl.authenticate.AuthenticationManagerDelegator;
import net.hlinfo.nacos.plugin.auth.impl.authenticate.DefaultAuthenticationManager;
import net.hlinfo.nacos.plugin.auth.impl.authenticate.IAuthenticationManager;
import net.hlinfo.nacos.plugin.auth.impl.authenticate.LdapAuthenticationManager;
import net.hlinfo.nacos.plugin.auth.impl.constant.AuthSystemTypes;
import net.hlinfo.nacos.plugin.auth.impl.filter.JwtAuthenticationTokenFilter;
import net.hlinfo.nacos.plugin.auth.impl.roles.NacosRoleServiceImpl;
import net.hlinfo.nacos.plugin.auth.impl.token.TokenManagerDelegate;
import net.hlinfo.nacos.plugin.auth.impl.users.NacosUserDetailsServiceImpl;
...
public class NacosAuthConfig {
    ...
    @PostConstruct
    public void init() {
        methodsCache.initClassMethod("net.hlinfo.nacos.plugin.auth.impl.controller");
    }
    ...
    public GlobalAuthenticationConfigurerAdapter authenticationConfigurer() {
        return new GlobalAuthenticationConfigurerAdapter() {
            ...
            public void init(AuthenticationManagerBuilder auth) throws Exception {
                ...
                } else if (AuthSystemTypes.NACOS_PG.name().toLowerCase().equalsIgnoreCase(authConfigs.getNacosAuthSystemType().toLowerCase())) {
                    auth.userDetailsService(userDetailsService).passwordEncoder(passwordEncoder());
                }
            }
        };
